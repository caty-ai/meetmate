...
อยากให้อวาตาร์ขยับ? มีเส้นทางทดลองให้ใช้แล้ว 2 แบบ: อวาตาร์ลิปซิงก์แบบสลับเฟรมที่สลับ PNG 6 ภาพตามจังหวะเสียงพูด (v8.4.0) และ proof of concept ของริก 2.5D ค่าเริ่มต้นยังคงเป็นภาพนิ่ง — วิธีลองใช้อยู่ใน[หัวข้ออวาตาร์แบบสลับเฟรมของคู่มือติดตั้ง](https://github.com/caty-ai/meetmate/blob/main/docs/setup-guide.md#実験的なフレーム差し替えアバター)
