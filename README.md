...
<p align="center"><sub>generation: <code>2a6a587</code> (2026-09-05T03:03:11Z) · verify: <a href="https://api.github.com/repos/caty-ai/meetmate/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
| Hub token | Authenticate this installation with hosted cloud arbitration | Connect from **Settings → Connections → Cloud arbitration** (direct env configuration is not supported) | Hosted hub | Provisioned by the settings UI; do not copy it into logs or shared files. |
