...
<p align="center"><sub>generation: <code>7457fe8</code> (2026-09-04T14:30:42Z) · verify: <a href="https://api.github.com/repos/caty-ai/meetmate/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
| Hub token | Authenticate this installation with hosted cloud arbitration | `hub_token` (settings UI, masked) / `HUB_TOKEN` | Hosted hub | Provisioned by **Settings → Connections → Cloud arbitration**; do not copy it into logs or shared files. |
