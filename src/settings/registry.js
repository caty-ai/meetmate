...
const SETTINGS_REGISTRY = Object.freeze([
  ...
  d("openai_base_url", "llm.openaiCompatible.baseUrl", exactUrl(["http:", "https:"], true), { envAlias: "OPENAI_COMPATIBLE_BASE_URL", defaultValue: "" }),
  ...
  d("soniox_ws_url", "stt.soniox.wsUrl", exactUrl(["wss:"]), { envAlias: "SONIOX_WS_URL", defaultValue: "wss://stt-rt.soniox.com/transcribe-websocket" }),
  d("soniox_endpoint_sensitivity", "stt.soniox.endpointSensitivity", nullable(number(-1, 1)), { envAlias: "SONIOX_ENDPOINT_SENSITIVITY", defaultValue: null }),
  d("soniox_max_endpoint_delay_ms", "stt.soniox.maxEndpointDelayMs", nullable(integer(0, 30000)), { envAlias: "SONIOX_MAX_ENDPOINT_DELAY_MS", defaultValue: null }),
  d("soniox_endpoint_latency_level", "stt.soniox.endpointLatencyLevel", nullable(integer(0, 5)), { envAlias: "SONIOX_ENDPOINT_LATENCY_LEVEL", defaultValue: null }),
  ...
  d("fish_audio_voice_id", "tts.voiceId", trimmedString(256), { ux: "basic", envAlias: "FISH_AUDIO_VOICE_ID", requiredAtMeetingStart: true }),
  d("tts_provider", "tts.provider", z.literal("fish-audio"), { ux: "basic", envAlias: "TTS_PROVIDER", defaultValue: "fish-audio" }),
  d("fish_audio_model", "tts.model", trimmedString(128), { envAlias: "FISH_AUDIO_MODEL", defaultValue: "s2-pro" }),
  d("fish_audio_speed", "tts.speed", number(0.5, 2), { envAlias: "FISH_AUDIO_SPEED", defaultValue: 1 }),
  d("fish_audio_latency", "tts.latency", z.enum(["normal", "balanced", "low"]), { envAlias: "FISH_AUDIO_LATENCY", defaultValue: "balanced" }),
