...
const SETTINGS_REGISTRY = Object.freeze([
  ...
  d("hub_installation_id", "hub.installationId", trimmedString(256), { ux: "hidden" }),
  d("hub_cloud_hub_url", "hub.cloudHubUrl", exactUrl(["ws:", "wss:"]), { ux: "hidden" }),
  d("hub_url", "hub.url", exactUrl(["ws:", "wss:"]), { ux: "hidden", envAlias: "HUB_URL" }),
  d("hub_room_salt", "hub.roomSalt", secret, { ux: "hidden", credential: "class-1" }),
  d("hub_room_salt_version", "hub.roomSaltVersion", trimmedString(128), { ux: "hidden" }),
  d("hub_plan_id", "hub.planId", trimmedString(128), { ux: "hidden" }),
  d("hub_expires_at", "hub.expiresAt", z.string().datetime({ offset: true }), { ux: "hidden" }),
  d("hub_config_refreshed_at", "hub.configRefreshedAt", z.string().datetime({ offset: true }), { ux: "hidden" }),
